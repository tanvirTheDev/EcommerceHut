  ...
  return (
    <div className="flex items-center justify-center space-x-2">
      ...
      <button
        ...
        className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors duration-200 ${disabled ? "bg-gray-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-600"}`}
        disabled={disabled}
      >
